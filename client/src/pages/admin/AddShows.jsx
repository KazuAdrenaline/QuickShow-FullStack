      ...
      <div className="overflow-x-auto pb-4">
                ...
                <div key={movie.id} className={`relative max-w-40 cursor-pointer group-hover:not-hover:opacity-40 hover:-translate-y-1 transition duration-300 `} onClick={()=> setSelectedMovie(movie.id)}>
                    <div className="relative rounded-lg overflow-hidden">
                        ...
                        <div className="text-sm flex items-center justify-between p-2 bg-black/70 w-full absolute bottom-0 left-0">
                                    ...
                                    <p className="text-gray-300">{kConverter(movie.vote_count)} Lượt đánh giá</p>
                                </div>
                    </div>
       ...
       <div className="mt-8">
            ...
            <div className="inline-flex items-center gap-2 border border-gray-600 px-3 py-2 rounded-md">
                ...
                <input min={0} type="number" value={showPrice} onChange={(e) => setShowPrice(e.target.value)} placeholder="Nhập giá vé" className="outline-none" />
            </div>
        </div>
       ...
       {/* Display Selected Times */}
        ...
        <div className="mt-6">
            <h2 className=" mb-2">Danh sách ngày – giờ đã chọn</h2>
